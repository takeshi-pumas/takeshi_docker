...
if __name__== '__main__':
    ...
    with sm:
        ...
        smach.StateMachine.add("SCAN_FLOOR",    Scan_floor(),      transitions =
 {'failed':'INITIAL',      'succ':'PRE_GRASP_FLOOR','above':'PRE_GRASP_FLOOR_ABOVE'  ,  'tries':'INITIAL' , 'clear':'GOTO_TABLE'}, remapping= {'clear_table1_flag':'clear1','clear_table2_flag':'clear2'})         
